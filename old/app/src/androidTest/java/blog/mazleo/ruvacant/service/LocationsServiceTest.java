...
public class LocationsServiceTest {
    ...
    @Test
    public void downloadLocationsFromRutgersCoursesTest() {
        Gson gson = new GsonBuilder().registerTypeAdapter(Locations.class, new LocationsDeserializer()).create();
        OkHttpClient client = new OkHttpClient.Builder()
                .callTimeout(30, TimeUnit.SECONDS)
                .connectTimeout(30, TimeUnit.SECONDS)
        ...
        Observable<Locations> locationsObservable = service.retrieveLocationsFromRutgersCourses(
                "198",
                "92019",
                "NB",
                "U"
